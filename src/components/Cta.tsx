...
export default function Cta() {
  const stats = [
    ...
    { value: "45%", label: "Avg. Efficiency Gain", icon: TrendingUp },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join leading manufacturers who have streamlined their operations with our SAP ERP integration solutions. 
                Transform your production efficiency and data visibility today.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Comprehensive SAP integration readiness evaluation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                SOC 2 compliant with 99.8% system reliability
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Go-live in 8-12 weeks with proven methodologies
              </p>
            </div>
          </div>
        </div>
